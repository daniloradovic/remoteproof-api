...
return [
    ...
    // The release version of your application. Falls back to APP_VERSION (set during deploy
    // by the Forge deploy script) so Sentry tags every event with the live commit SHA.
    ...
    'ignore_transactions' => [
        // Ignore Laravel's default health URL and our public API health endpoint
        // so the uptime monitor's per-minute pings don't drown out real traces.
        '/up',
        '/api/health',
    ],
